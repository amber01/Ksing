//
//  schoolSongListViewController.m
//  K歌卡路里
//
...
@interface SchoolSongListViewController ()

@end

@implementation SchoolSongListViewController
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [SchoolSongListViewController isFileExist:mp3Names];
...
- (void)initURL
{
    NSString *pathStr = @"http://120.27.49.100:8000/api/get_songs_by_category/?category=3";
