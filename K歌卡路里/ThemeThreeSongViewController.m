//
//  ThemeThreeSongViewController.m
//  K歌卡路里
//
...
@implementation ThemeThreeSongViewController
- (id)init
{
    self = [super init];
    if (self) {
        self.title = @"昨天的日记今天的回忆";
    }
    return self;
}
...
- (void)stopViewLoading
{
    ...
    UIImageView *imageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"003"]];
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [ThemeThreeSongViewController isFileExist:mp3Names];
