...
@interface ChildSongListViewController ()

@end

@implementation ChildSongListViewController
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [ChildSongListViewController isFileExist:mp3Names];
...
- (void)initURL
{
    NSString *pathStr = @"http://120.27.49.100:8000/api/get_songs_by_category/?category=8";
