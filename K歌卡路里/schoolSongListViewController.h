//
//  schoolSongListViewController.h
//  K歌卡路里
//
...
@interface SchoolSongListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,ASIHTTPRequestDelegate>
{
