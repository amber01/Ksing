//
//  PopSongListViewController.m
//  K歌卡路里
//
//  Created by amber on 14/11/26.
...
@interface PopSongListViewController ()

@end

@implementation PopSongListViewController
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [PopSongListViewController isFileExist:mp3Names];
...
- (void)initURL
{
    NSString *pathStr = @"http://120.27.49.100:8000/api/get_songs_by_category/?category=1";
