...
- (void)setBackgroundImage:(UIImage *)backgroundImage {
    if (backgroundImage) {
        //_bannerImageView.frame = CGRectMake(0,-20, ScreenWidth, 450/2);
...
- (void)_setup {
    ...
    [_avatarButton addTarget:self action:@selector(addImageAction) forControlEvents:UIControlEventTouchUpInside];
