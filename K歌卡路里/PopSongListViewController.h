...
@class SingViewController;


@interface PopSongListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,ASIHTTPRequestDelegate,SDWebImageDownloaderDelegate>
{
