//
//  EuropeAmSongListViewController.h
//  K歌卡路里
//
...
@interface EuropeAmSongListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,ASIHTTPRequestDelegate>
{
