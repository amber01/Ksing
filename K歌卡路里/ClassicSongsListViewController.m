//
//  SKClassicSongListViewController.m
//  SingKCAL
//
//  Created by amber on 14/12/26.
...
@interface ClassicSongsListViewController ()

@end

@implementation ClassicSongsListViewController
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [ClassicSongsListViewController isFileExist:mp3Names];
