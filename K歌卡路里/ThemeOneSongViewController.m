...
@implementation ThemeOneSongViewController
- (id)init
{
    self = [super init];
    if (self) {
        self.title = @"有没有一首歌让你想起TA";
    }
    return self;
}
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [ThemeOneSongViewController isFileExist:mp3Names];
