//
//  JapanKorSongListViewController.h
//  K歌卡路里
//
...
@interface JapanKorSongListViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,ASIHTTPRequestDelegate>
{
