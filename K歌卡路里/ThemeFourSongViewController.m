...
@implementation ThemeFourSongViewController
- (id)init
{
    self = [super init];
    if (self) {
        self.title = @"最美的声音最美的青春";
    }
    return self;
}
...
- (void)stopViewLoading
{
    ...
    UIImageView *imageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"004"]];
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [ThemeFourSongViewController isFileExist:mp3Names];
