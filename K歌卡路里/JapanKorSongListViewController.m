//
//  JapanKorSongListViewController.m
//  K歌卡路里
//
...
@interface JapanKorSongListViewController ()

@end

@implementation JapanKorSongListViewController
...
- (void)songLoadAction:(UIButton *)button
{
    ...
    BOOL isFile = [JapanKorSongListViewController isFileExist:mp3Names];
...
- (void)initURL
{
    NSString *pathStr = @"http://120.27.49.100:8000/api/get_songs_by_category/?category=11";
